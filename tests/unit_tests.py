...
print("STARTING FILE SERVER ON PORT 8001")
...
run_text_cmd = 'python3 {0} &'.format(os.path.join(test_folder, 'text_server.py'))

result = os.system(run_text_cmd)

print("STARTING IMAGE SERVER")

run_img_cmd = 'python3 {0} &'.format(os.path.join(test_folder, 'image_server.py'))

result = os.system(run_img_cmd)

run_csv_cmd = 'python3 {0} &'.format(os.path.join(test_folder, 'csv_server.py'))

result = os.system(run_csv_cmd)

print("STARTING CSV SERVER")

run_JSON_cmd = 'python3 {0} &'.format(os.path.join(test_folder, 'json_server.py'))

result = os.system(run_JSON_cmd)

print("STARTING JSON SERVER")

run_file_cmd = 'python3 {0} &'.format(os.path.join(test_folder, 'file_server.py'))
